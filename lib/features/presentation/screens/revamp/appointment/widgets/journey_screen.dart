...
class _JourneyScreenState extends State<JourneyScreen> {
  ...
  void initState() {
    ...
    selectedJourneySteps.add('I\'ve been tracking or thinking about it for a while');
    selectedJourneySteps.add('I\'m not sure what to do next');
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Title
          Text(
            'Where are you in your journey with this concern and what have you already tried?',
