...
import 'package:foxxhealth/features/presentation/screens/revamp/den/den_screen.dart';
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  void initState() {
    super.initState();
    // Fetch user profile when main navigation loads
...
class _TrackerTabState extends State<TrackerTab> {
  ...
  Widget _buildRecentSymptomsCards() {
    final recentSymptoms = ['Aches & pain', 'Anxiety', 'Redness'];
