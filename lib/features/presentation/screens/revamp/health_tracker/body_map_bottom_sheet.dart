    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (_selectedBodyParts.isNotEmpty) _buildSelectedTags(),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              // Save selected body parts
              Navigator.of(context).pop(_selectedBodyParts.toList());
            },
            child: Text(
              'Save',
