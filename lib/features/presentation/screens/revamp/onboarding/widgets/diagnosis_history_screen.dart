...
class DiagnosisHistoryScreen extends StatefulWidget {
  ...
  const DiagnosisHistoryScreen({super.key, this.onNext, this.questions = const []});
...
class _DiagnosisHistoryScreenState extends State<DiagnosisHistoryScreen> {
  ...
  List<String> get _diagnoses {
    final question = OnboardingService.getQuestionByType(widget.questions, 'HEALTH_HISTORY');
    if (question != null) {
