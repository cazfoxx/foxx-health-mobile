...
class HealthConcernsScreen extends StatefulWidget {
  ...
  const HealthConcernsScreen({super.key, this.onNext, this.questions = const []});
...
class _HealthConcernsScreenState extends State<HealthConcernsScreen> {
  ...
  List<String> get _healthConcerns {
    final question = OnboardingService.getQuestionByType(widget.questions, 'HEALTH_CONCERNS');
    if (question != null) {
