...
class SymptomDetailsHelper {
  static Map<String, dynamic>? getMockSymptomDetails(String symptomId) {
    ...
    if (symptomId == 'ABDOMINAL_PAIN') {
      return {
        "id": symptomId,
        "info": {
          "id": symptomId,
          "name": "Abdominal pain",
          "filter_grouping": ["Period"],
          "body_parts": ["Abdomen"],
          "tags": ["Lower left", "Lower right", "Upper left", "Upper right"],
          "visual_insights": ["line_chart", "intensity", "bubble_cluster"],
          "question_map": [
            {
              "question_id": "ONSET",
              "question_text": "How did the symptom begin?",
              "question_type": "multiple_choice",
              "question_options": [
                {"id": "sudden", "text": "It came on suddenly"},
                {"id": "gradual", "text": "It built up gradually"},
                {"id": "not_sure", "text": "I'm not sure / can't remember"}
              ],
              "is_starting_question": true,
              "question_description": null
            },
            ...
            {
              "question_id": "PAIN_RELIEVED_BY_ACTIVITY",
              "question_text": "Pain relieved by activity?",
              "question_type": "multiple_choice",
              "question_options": [
                {"id": "yes", "text": "Yes"},
                {"id": "no", "text": "No"}
    ...
    // Default mock data for other symptoms
    return {
      "id": symptomId,
      "info": {
        "id": symptomId,
