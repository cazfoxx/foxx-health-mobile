...
class PrescriptionHealthAssessmentScreen extends StatefulWidget {
  const PrescriptionHealthAssessmentScreen({super.key});

  @override
  State<PrescriptionHealthAssessmentScreen> createState() =>
      _PrescriptionHealthAssessmentScreenState();
}

class _PrescriptionHealthAssessmentScreenState
          ...
          Container(
            ...
            child: OnboardingButton(
              ...
              onPressed: () {
                ...
                // Update health assessment cubit with prescriptions
                final healthCubit = context.read<HealthAssessmentCubit>();
                healthCubit.setPreExistingConditionText(_additionalNotes.join(', '));

                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PreppingAssessmentScreen()),
                );
              },
            ),
          ),
